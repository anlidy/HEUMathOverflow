...
func NewUserHandler(userService service.UserService) UserHandler {
	return UserHandler{userService: userService, name: "User-Handler"}
}

// 用户注册
func (uc *UserHandler) UserRegister(c *gin.Context) {
...
// 用户退出登录
func (uc *UserHandler) UserLogout(c *gin.Context) {
	var ctx = c.Request.Context()
...
// 上传头像
func (uc *UserHandler) UserUploadAvatar(c *gin.Context) {
	var ctx = c.Request.Context()
	userID := c.GetInt64("userID")
...
// 下载头像
func (uc *UserHandler) UserDownloadAvatar(c *gin.Context) {
	var ctx = c.Request.Context()
...
// 修改用户信息
func (uc *UserHandler) UserUploadProfie(c *gin.Context) {
	var ctx = c.Request.Context()
...
// 更新用户密码
func (uc *UserHandler) UserUpdatePassword(c *gin.Context) {
	var ctx = c.Request.Context()
	var userID = c.GetInt64("userID")
...
// 用户注销账号
func (uc *UserHandler) UserDeleteAccount(c *gin.Context) {
	var ctx = c.Request.Context()
	var userID = c.GetInt64("userID")
	sessionID, err := c.Cookie("session-id")
	if err != nil || sessionID == "" {
